-- Update the default template to use scoreData
...
Remember to demonstrate enough value to motivate booking a strategy session while reserving complete solutions for paid services.$template$
